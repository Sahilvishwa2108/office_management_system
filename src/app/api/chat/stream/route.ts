...
// import { pubSubRedis } from "@/lib/redis";
...
//       pubSubRedis.subscribe("chat_messages", (err, count) => {
//         if (err) {
//           console.error("❌ Redis subscription failed:", err);
//           return;
//         }
//         console.log("✅ Subscribed to chat_messages channel");
//       });

//       pubSubRedis.on("message", messageHandler);
...
//         pubSubRedis.unsubscribe("chat_messages").catch(console.error);
//         pubSubRedis.off("message", messageHandler);
